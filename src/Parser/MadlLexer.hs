...
madlDef = emptyDef {
    ...
    , reservedNames  = [
        ...
        , "CtrlJoin", "DeadSink", "FCtrlJoin", "Fork", "Function", "Joitch", "LoadBalancer", "Match" -- Madl primitives
        , "Merge", "MultiMatch", "PatientSource", "Queue", "Sink", "Source", "Switch", "Vars" -- Madl primitives
